...
impl PackageBuilder {
    fn new(name: impl Into<String>) -> Self {
        let mut pc = Package{name: name.into(), version: String::from(""), authors: Vec::new(), dependencies: Vec::new(), language: None };
        //pc.name = name;
        return PackageBuilder{0: pc};
    }
    ...
    fn language(mut self, language: Language) -> Self {
        self.0.language = Option::from(language);
        self
    }
